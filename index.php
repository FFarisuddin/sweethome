...
$cities = ["Jakarta", "Bogor", "Depok", "Tangerang", "Bekasi", "Bandung", "Surabaya"];
?>

<h2 class="text-center" style="margin-top: 20px">toktok</h2>
<hr>
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
				...
				<option value="Wter Pipe">Water Pipe</option>
            </select>
        </div>
                ...
                $.post('scripts/searchproviders.php', {
                    ...
                    if (providers.failed == true) {
                        ...
                        providers.forEach(function(provider, i) {
                            tbody += "<tr>" +
                                "<td><img style='height:60px' src='storage/" + provider
                                .photo +
                                "'/></td>" +
                                "<td>" + provider.name + "</td>" +
